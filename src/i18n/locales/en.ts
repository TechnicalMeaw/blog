...
const baseStrings = {
  "site.title": "Engineering Notes",
  "site.desc":
    "Engineering notes on Flutter, backend systems, scalability, and real-world software architecture.",
};

const ENLocale: I18nStrings = {
  ...baseStrings,
  "hero.title": "Santanu Mukherjee",
  "hero.body": `
        Thoughts, lessons, and deep dives from building real-world systems —
        Flutter apps, backend architectures, and scalable cloud workflows.
`,
  "hero.beforeReadme": "Read the blog posts or check",
  "hero.readme": "Portfolio",
